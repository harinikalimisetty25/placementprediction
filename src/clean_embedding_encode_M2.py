...
df = pd.read_csv("C:/Users/harin/PythonProject/placement_prediction/dataset/clean_target_encode_M2.csv")
...
final_output.to_csv(
   "C:/Users/harin/PythonProject/placement_prediction/dataset/clean_embedded_encode_M2.csv",
   index=False
)
