...
FILE_NAME = "C:/Users/harin/PythonProject/placement_prediction/dataset/final_preprocess_M2.csv"

output_folder = (
    "C:/Users/harin/PythonProject/placement_prediction/"
    "dataset/Regularization_ridg_laso_elastic_outputs"
)
...
# Extract distinct, non-duplicate values from the dataset
...
comparison.to_csv(
    "C:/Users/harin/PythonProject/placement_prediction/"
    "dataset/regularisation_model_comparison_m2.csv",
    index=False
)
...
coefficient_table.to_csv(
    "C:/Users/harin/PythonProject/placement_prediction/"
    "dataset/regularisation_coefficient_M2.csv",
    index=False
)
...
print(
    "\nSaved:"
    "\nregularisation_coefficient_M2.csv"
)
...
lasso_features.to_csv(
    "C:/Users/harin/PythonProject/placement_prediction/"
    "dataset/lasso_feature_selection_M2.csv",
    index=False
)
...
print("\n================================================")
print("VERIFY ORIGINAL PLACEMENT PREDICTION PREPROCESSED DATASET")
print("================================================")
